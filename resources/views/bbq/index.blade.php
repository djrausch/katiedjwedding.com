    ...
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-md-10 col-md-offset-1 header-hero shadow">
            ...
            <div class="header-hero-text">
                ...
                <h4 class="text-center oxygen"><a href="#info">Info</a> |
            ...
            <div class="col-md-10 col-md-offset-1">
                <div>
                    ...
                    <p>
                        Everyone is also invited to attend our church gathering at <a href="http://secondmile520.org" target="_blank">Second Mile</a> at 4:00 PM. Let us know if you plan to attend so we can save seats!
                    </p>
